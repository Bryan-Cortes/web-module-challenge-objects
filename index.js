...
*/
console.log(createMenuItem("Smoothie", 5, "Drinks"));
console.log(createMenuItem("Veggie Burger", 15, "Lunch"));
console.log(createMenuItem("Cookies", 2, "Snacks"));
...
reviews.push({name:"Bryan", rating: 5, feedback: 'Very happy with my stay. I will be coming back and invite more people to come.'})
console.log(reviews);
